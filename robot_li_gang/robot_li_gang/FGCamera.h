...
#define WPARAM_ERROR                    1       // LPARAM = Error flags
...
// Parameter DCAM: Rate specifies the color mode when FORMAT 7 selected!
...
enum FG_PARAMETER
{
  ...
  FGP_USEIRMFORCHN,                             // Get channel over ISORM
...
typedef struct                                  // Parameters for init
{
  ...
  UINT32        Flags;                          // FGCamera context interpreted as hWnd
}FGINIT;
